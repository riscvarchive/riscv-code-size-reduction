<<<
[#insns-cm_lhu,reftext="cm.lhu: Load unsigned halfword, 16-bit encoding"]
=== cm.lhu
...
[NOTE]
  If _uimm < 4_ the encoding is reserved for custom use, as the functionality overlaps with <<insns-c_lhu>>.
