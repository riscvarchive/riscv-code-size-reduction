<<<
[#insns-c_pusha,reftext="c.pusha: push 2 to 4 registers to stack memory and move 1 to 3 argument registers into saved registers, 16-bit encoding"]
=== c.pusha

Synopsis::
Push 2 to 4 registers to stack memory and move 1 to 3 argument registers into saved registers, 16-bit encoding
...
moves _areg_list_1_3_ into similarly numbered _s_ registers, 
