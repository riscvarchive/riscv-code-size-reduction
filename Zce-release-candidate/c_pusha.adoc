...
[NOTE]
  ...
  _rlist_ value 4 is reserved, in contrast to _c.push_, _c.pop_, _c.popret_, _c.popretz_
...
switch (rlist){
  case     5: {areg_list="a0";    xareg_list="x10";}
  case     6: {areg_list="a0-a1"; xareg_list="x10-x11";}
...
switch (rlist){
  case     5: {areg_list="a0";    xareg_list="x10";}
  case     6: {areg_list="a0-a1"; xareg_list="x10-x11";}
  case     7: {areg_list="a0-a2"; xareg_list="x10-x12";}
  case 8..15: {areg_list="a0-a3"; xareg_list="x10-x13";}
  default:    take_illegal_instruction_exception();
}
--
