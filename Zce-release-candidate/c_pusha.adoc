...
[source,sail]
--
if (rlist2==1) {areg_list_1_3="a0";    xareg_list_1_3="x10";}
if (rlist2==2) {areg_list_1_3="a0-s1"; xareg_list_1_3="x10-x11";}
if (rlist2==3) {areg_list_1_3="a0-s2"; xareg_list_1_3="x10-x12";}
--

[source,sail]
--
if (rlist2==1) {reg_list_2_4="ra, s0";    xreg_list_2_4="x1, x8";}
if (rlist2==2) {reg_list_2_4="ra, s0-s1"; xreg_list_2_4="x1, x8-x9";}
if (rlist2==3) {reg_list_2_4="ra, s0-s2"; xreg_list_2_4="x1, x8-x9, x18";}
