...
|====================================================================================
|Instruction  7+| subset                         
|               |Zca|Zcf|Zcb|Zcyh|Zcyp|Zcype|Zcyt
8+|The new extensions are based on C with the FP load/stores removed
|C excl. c.f*   |&#10003;|   |   |    |    |     |     
8+|These floating point load/stores become a separate extension
|c.flw          |   |&#10003;|   |    |    |     |     
|c.flwsp        |   |&#10003;|   |    |    |     |     
|c.fsw          |   |&#10003;|   |    |    |     |     
|c.fswsp        |   |&#10003;|   |    |    |     |     
...
This extension reuses encodings for c.fld, c.fldsp, c.fsd, c.fsdsp.  Therefore it is _incompatible_ with D. 
...
Zcpye offers EABI support for register mappings where the _x_ register mapping is different to the UABI. 
