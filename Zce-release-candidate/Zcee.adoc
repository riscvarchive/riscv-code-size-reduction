...
The _c.mul_ encoding has the register sources/destination in the same fields as other 16-bit encodings such as _c.sub_, _c.xor_ etc. 

_c.mul_ has a high benefit for audio processing algorithms and for a variety of other benchmarks.
