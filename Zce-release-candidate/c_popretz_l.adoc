<<<
[#insns-c_popretz_l,reftext="c.popretz.l: pop 5 to 13 registers from stack memory and returns zero, 16-bit encoding"]
=== c.popretz.l

Synopsis::
Pop 5 to 13 registers from stack memory and return zero, 16-bit encoding

Mnemonic::
c.popret _{reg_list_5_13}, {0}, stack_adj_
...
[source,sail]
--
c.popret {<reg_list_5_13> | <xreg_list_5_13>}, {0}, -<stack_adj>
--
