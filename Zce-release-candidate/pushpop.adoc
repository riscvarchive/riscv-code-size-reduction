...
----
0001080e <processMarkers>:
   1080e:       xxxx                    c.push    {ra,s0-s11},{a0-a3},-96
...
[NOTE]
  ...
  _c.pusha_ has three additional register moves included _mv s1, a1, mv s2, a2, mv s3, a3_ which weren't in the original prologue. 
  Also, the _s4_ register needs to be reallocated to _s0_ to fit _c.pusha_.
