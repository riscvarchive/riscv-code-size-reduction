...
----
0001080e <processMarkers>:
   1080e:       xxxx                    cm.push    {ra,s0-s11},-96
...
   10866:       xxxx                    cm.popretz {ra,s0-s11}, 96
----
...
The instructions have a restricted range of _spimm_ available. If this is insufficient then a separate _cm.addi16sp_ can be used to increase the range.
