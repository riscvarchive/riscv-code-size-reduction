<<<
[#insns-cm_lh,reftext="cm.lh: Load signed halfword, 16-bit encoding"]
=== cm.lh
...
[NOTE]
  If _uimm < 4_ the encoding is reserved for custom use, as the functionality overlaps with <<insns-c_lh>>.
