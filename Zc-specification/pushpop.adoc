...
In this case the fault handler should complete the sequence in software. In this case xTVAL must be written with the bad address to allow the handler to complete the sequence.
