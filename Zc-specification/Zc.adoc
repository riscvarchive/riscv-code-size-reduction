...
| CLBU   | c.lbu              | funct6 3+| rs1'    3+| uimm    2+| rd'    2+| op
| CSB    | c.sb               | funct6 3+| rs1'    3+| uimm    2+| rs2'   2+| op
| CLH    | c.lhu, c.lh        | funct6 3+| rd'/rs1'| f1 2+| uimm 2+| rd'  2+| op
| CSH    | c.sh               | funct6 3+| rd'/rs1'| f1 2+| uimm 2+| rs2' 2+| op
| CSZN   | c.[sz]ext.*, c.not | funct6 3+| rd'/rs1' 5+| funct5            2+| op
| CMVSA  | cm.mvsa01 cm.mva01s| funct6 3+| r1s     2+| funct2 3+| r2s     2+| op
