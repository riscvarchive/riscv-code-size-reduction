...
execute permission; read permission is irrelevant. The address of the second fetch is not considered to be a PC, and so cannot be used for PC based debugging, tracing etc.
