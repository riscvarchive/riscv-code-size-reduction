...
The results from such are shown in the table below:
...
However, for fair reporting, we need to reference these results to the file sizes compiled with msave-restore, as shown below: 
